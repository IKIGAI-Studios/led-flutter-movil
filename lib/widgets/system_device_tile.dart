...
class _SystemDeviceTileState extends State<SystemDeviceTile> {
  ...
  Widget build(BuildContext context) {
    return ListTile(
      title: Text(widget.device.platformName, style: const TextStyle(color: Color.fromRGBO(217, 217, 217, 1)),),
      subtitle: Text(widget.device.remoteId.str, style: const TextStyle(color: Color.fromRGBO(217, 217, 217, 1))),
